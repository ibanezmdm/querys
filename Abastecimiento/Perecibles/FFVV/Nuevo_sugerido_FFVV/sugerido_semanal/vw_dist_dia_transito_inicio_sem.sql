...
CREATE VIEW [dbo].[vw_dist_dia_transito_inicio_sem]
...
AS
	 ...
	 *	Updated_at:		----/--/--
	 *	Cambios:			
	 *	-- ?? SELECT * FROM [NUEVO_SUGERIDO_FFVV].[dbo].[vw_dist_dia_transito_inicio_sem] where cod_local = 104 and sku = 5014004
	 */
	...
	with forecast as (
		...
		select 
			...
			'compra' tipo
		from NUEVO_SUGERIDO_FFVV.dbo.NSFFVV_dist_dia_estimacion_compra_sem ec
