USE [INFORMES3]
GO
/****** Object:  StoredProcedure [dbo].[Sp_NUEVO_INSTOCK_MAIL_SUBDEPTO]    Script Date: 06-01-2020 18:02:59 ******/
SET ANSI_NULLS ON
GO
...
-- EXEC [INFORMES3].[dbo].[Sp_NUEVO_INSTOCK_MAIL_SUBDEPTO_TOP2100_v2]
-- =============================================
ALTER PROCEDURE [dbo].[Sp_NUEVO_INSTOCK_MAIL_SUBDEPTO_TOP2100_v2]
AS
BEGIN
