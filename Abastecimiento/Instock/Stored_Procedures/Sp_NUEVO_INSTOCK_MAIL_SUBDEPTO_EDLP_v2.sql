...
-- EXEC [INFORMES3].[dbo].[Sp_NUEVO_INSTOCK_MAIL_SUBDEPTO_EDLP_v2]
-- =============================================
ALTER PROCEDURE [dbo].[Sp_NUEVO_INSTOCK_MAIL_SUBDEPTO_EDLP_v2]
AS
BEGIN
	...
	TRUNCATE TABLE [INFORMES3].[dbo].[NUEVO_INSTOCK_MAIL_SUBDEPTO_EDLP]


	INSERT INTO [INFORMES3].[dbo].[NUEVO_INSTOCK_MAIL_SUBDEPTO_EDLP]
	...
	FROM (
		...
		*/
		...
		INNER JOIN [INSTOCK_OPT].dbo.SKU_EDLP EDLP
			ON EDLP.SKU = I.SKU
		WHERE
