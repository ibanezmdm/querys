...
-- TRUNCATE TABLE [INFORMES3].[dbo].[INSTOCK_CARNES_CERDO_TOTAL_ASISTIDO]

-- INSERT INTO [INFORMES3].[dbo].[INSTOCK_CARNES_CERDO_TOTAL_ASISTIDO] (
-- 	[RESUMEN]
-- 	,[INSTOCK]
-- )

-- SELECT --SUBDEP
--       'TOTAL CERDO ASISTIDO' AS RESUMEN
...
-- ) AS T
--   WHERE (SUBDEP LIKE '%CERDO%') AND SUBCLASE LIKE '%ASISTIDO%'
--   GROUP BY SUBDEP
