...
-- TRUNCATE TABLE [INFORMES3].[dbo].[INSTOCK_CARNES_PAVO_TOTAL_ASISTIDO]

-- INSERT INTO [INFORMES3].[dbo].[INSTOCK_CARNES_PAVO_TOTAL_ASISTIDO] (
-- 	[RESUMEN]
-- 	,[INSTOCK]
-- )

-- SELECT --SUBDEP
--       'TOTAL PAVO ASISTIDO' AS RESUMEN
...
-- ) AS T
--   WHERE (SUBDEP LIKE '%PAVO%') AND SUBCLASE LIKE '%ASISTIDO%'
--   GROUP BY SUBDEP
