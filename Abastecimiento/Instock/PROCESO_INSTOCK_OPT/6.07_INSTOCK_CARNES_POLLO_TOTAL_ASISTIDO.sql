...
-- TRUNCATE TABLE [INFORMES3].[dbo].[INSTOCK_CARNES_POLLO_TOTAL_ASISTIDO]

-- INSERT INTO [INFORMES3].[dbo].[INSTOCK_CARNES_POLLO_TOTAL_ASISTIDO] (
-- 	[RESUMEN]
-- 	,[INSTOCK]
-- )
...
-- SELECT --SUBDEP
--       'TOTAL POLLO ASISTIDO' AS RESUMEN
