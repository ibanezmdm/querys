...
-- TRUNCATE TABLE [INFORMES3].[dbo].[INSTOCK_CARNES_CERDO_TOTAL_AUTOSERVICIO]

-- INSERT INTO [INFORMES3].[dbo].[INSTOCK_CARNES_CERDO_TOTAL_AUTOSERVICIO] (
-- 	[RESUMEN]
-- 	,[INSTOCK]
-- )

-- SELECT --SUBDEP
--       'TOTAL CERDO AUTOSERVICIO' AS RESUMEN
...
-- ) AS T
--   WHERE (SUBDEP LIKE '%CERDO%') AND SUBCLASE LIKE '%AUTOSERVICIO%'
--   GROUP BY SUBDEP
